...
export const ANIMALS: Animal[] = [
  ...
  },
  {
    ...
    tier: 2,
    parts: {
      head: { stats: { attack: 13, energy: 5 }, ability: "leech", trait: "predator" },
      body: { stats: { health: 32, defense: 5 } },
      forelimbs: { stats: { attack: 11 }, ability: "frenzy" },
      hindlimbs: { stats: { speed: 14 }, trait: "swift" },
      tail: { stats: { speed: 6 } },
    },
  },
  {
    ...
    tier: 2,
    parts: {
      head: { stats: { attack: 11, energy: 6 }, trait: "keenSenses" },
      body: { stats: { health: 22, defense: 4 } },
      forelimbs: { stats: { attack: 14, energy: 5 }, ability: "charge" },
      hindlimbs: { stats: { speed: 10 }, trait: "swift" },
      tail: { stats: { attack: 6 } },
    },
  },
  {
    ...
    tier: 2,
    parts: {
      head: { stats: { attack: 11, energy: 7 }, trait: "keenSenses" },
      body: { stats: { health: 28, defense: 6 }, ability: "armor" },
      forelimbs: { stats: { attack: 11, energy: 4 } },
      hindlimbs: { stats: { speed: 11 }, trait: "swift" },
      tail: { stats: { energy: 6 }, ability: "regenerate" },
    },
  },
  {
    ...
    tier: 2,
    parts: {
      head: { stats: { attack: 8, energy: 8 }, ability: "venom" },
      body: { stats: { health: 30, defense: 5 } },
      forelimbs: { stats: { attack: 10, energy: 5 }, ability: "leech" },
      hindlimbs: { stats: { speed: 7 } },
      tail: { stats: { energy: 8 } },
    },
  },
  {
    ...
    tier: 1,
    parts: {
      head: { stats: { attack: 6, energy: 8 }, ability: "venom", trait: "keenSenses" },
      body: { stats: { health: 20, defense: 3 } },
      forelimbs: { stats: { attack: 7, speed: 3 } },
      hindlimbs: { stats: { speed: 9 }, trait: "swift" },
      tail: { stats: { energy: 5 } },
    },
  },
  {
    ...
    tier: 1,
    parts: {
      head: { stats: { attack: 8, defense: 3 }, ability: "charge" },
      body: { stats: { health: 30, defense: 7 }, trait: "hardy" },
      forelimbs: { stats: { attack: 7 } },
      hindlimbs: { stats: { speed: 5 } },
      tail: { stats: { health: 7 } },
    },
  },
  {
    ...
    tier: 3,
    parts: {
      head: { stats: { attack: 14, energy: 6 }, ability: "frenzy", trait: "predator" },
      body: { stats: { health: 44, defense: 7 } },
      forelimbs: { stats: { attack: 11 }, ability: "leech" },
      hindlimbs: { stats: { speed: 11 }, trait: "swift" },
      tail: { stats: { attack: 9, speed: 6 } },
    },
  },
  {
    id: "phoenix",
    ...
    tier: 3,
    parts: {
      head: { stats: { attack: 13, energy: 10 }, ability: "spit", trait: "predator" },
      body: { stats: { health: 42, defense: 6 }, ability: "regenerate" },
      forelimbs: { stats: { attack: 11, energy: 7 }, ability: "frenzy" },
      hindlimbs: { stats: { speed: 10 }, trait: "swift" },
      tail: { stats: { attack: 8, energy: 8 }, ability: "spit" },
    },
  },
];
